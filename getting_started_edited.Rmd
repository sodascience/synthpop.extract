...
1.  ![cbs](img/cbs-logo.ico){width=22px} Upload a code file we have prepared (`sythpop_extractor.R`) to the CBS RA environment.
2.  ![cbs](img/cbs-logo.ico){width=22px} Estimate a parametric generative model for the dataset using the well-known `synthpop` 
    package in R.
3.  ![cbs](img/cbs-logo.ico){width=22px} Use our code to extract parameters of this generative model and ensure disclosure control according to 
...
3.  ![cbs](img/cbs-logo.ico){width=22px} Export the disclosure controlled parameters to an `xlsx` file.
4.  ![cbs](img/cbs-logo.ico){width=22px} Offer the `xlsx` file to the microdata team for output control.
...
<p class="note">![cbs](img/cbs-logo.ico){width=17px}: perform in CBS RA environment &nbsp; `r fa("computer", fill="#158cba")` : perform in your local device</p>
